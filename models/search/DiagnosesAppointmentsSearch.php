...
use ut8ia\medicine\models\DiagnosesAppointments;

/**
 * DiagnosesAppointments represents the model behind the search form of `ut8ia\medicine\models\DiagnosesAppointments`.
 */
